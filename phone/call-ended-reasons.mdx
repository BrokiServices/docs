...
<Note>
You can find `endedReason` in the [Call Object](/api-reference/calls/get-call-details) or in your call logs on the [CallHQ Dashboard](https://web.callhq.ai/call-logs).
</Note>
