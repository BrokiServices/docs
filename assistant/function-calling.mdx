...
<CardGroup cols={2}>
  <Card title="Transfer Call" icon="phone-arrow-right" href="/assistant/transfer-call">
    Set up call routing to human agents or destination numbers.
  </Card>

  <Card title="Custom Function" icon="code" href="/assistant/custom-function">
    Build a custom API integration for your assistant.
  </Card>

  <Card title="Variable Values" icon="user" href="/assistants/dynamic-variables">
    Pass dynamic conversation data into function parameters.
  </Card>

  <Card title="Test Your Assistant" icon="phone" href="/assistant/testing">
    Verify tool behavior before going live.
  </Card>
</CardGroup>
