...
To use dynamic variables in the dashboard, include them in your prompts or messages using curly braces. For example:
...
<Note>
Always use curly braces (`{variableName}`) to reference dynamic variables in your prompts and messages.
</Note>
