...
The Care Coordinator Assistant template helps you create assistants that guide patients through appointment scheduling, provide accurate information about services, and answer basic health-related questions with empathy and professionalism.

## What this template does

- Greets patients warmly and establishes a caring tone.
- Collects patient details while adhering to HIPAA compliance.
- Answers frequently asked questions about clinic services, providers, and general health topics.
- Schedules, reschedules, or cancels appointments with clear confirmation.
- Provides reminders, follow-ups, and next-step instructions.
- Uses clear, reassuring language throughout the conversation.
...
##  Agent Prompt
        ...
        **First message:**
        ...
        ```plaintext
      Thank you for calling Wellness Alliance Medical Group. This is Priya, your healthcare coordinator. This call is protected under HIPAA privacy regulations. How may I help you today?
        ```
...
Start with: "Thank you for calling Wellness Alliance Medical Group. This is Priya, your healthcare coordinator. This call is protected under HIPAA privacy regulations. How may I help you today?"
